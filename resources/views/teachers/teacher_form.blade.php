<x-app-layout>
    <x-slot name="header" >
        <h2 class="font-semibold text-xl text-gray-800 leading-tight ">
            ...
            @if (isset($teacher) && isset($person) )
                {{ __('Modification des informations de un enseignant') }}
            @else
        ...
        <div class=" h-96 flex  items-center justify-center">
            <div class=" rounded-lg h-auto w-full bg-white flex flex-col justify-center items-center ">
                <div class="text-white bg-gray-900 w-full h-7 flex ">
                    ...
                    <div class="">
                       {{__("Identifiants de l'enseignant")}}
                    </div>
                </div>
                ...
                <div class="w-full p-5 ">
                    ...
                    <form class="border p-2 w-full h-auto flex flex-col items-center" method="post" action="{{ route('teacher.edit', ['id' =>  $teacher->id]) }}" enctype="multipart/form-data">

                    @method('PUT')

                    @else

                    <form class="border p-2 w-full h-auto flex flex-col items-center" action="{{route('teacher.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-6 flex flex-col  h-full w-full  border">
                                    ...
                                    <div class="flex  w-1/5 flex-col ">
                                        ...
                                        <div class="flex  flex-around   ">
                                            <div class="flex items-center ">
                                                <input id="M" type="radio" value="M" {{ old('gender') == 'M' ? 'checked' : '' }} name="gender" class="w-4 h-4 text-gray-900 bg-gray-100 border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                <label for="M" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">M</label>
                                            </div>
                                            <div class="flex items-center ml-4">
                                                <input id="F" type="radio" value="F" {{ old('gender') == 'F' ? 'checked' : '' }} name="gender" class="w-4 h-4 text-gray-900 bg-gray-100 border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <div class="w-full border flex flex-between px-6 py-2">
                                    <div class="flex  w-full flex-col ">
                                        <label for="startAt" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Employé depuis le</label>
                                        <div class="flex items-center w-80">
